...
Every entry follows the same rough shape (see `TEMPLATE.md`):

1. **The question** — stated as precisely as I can manage.
2. **Conjectures** — candidate answers, stated boldly.
